...
namespace Sito.ServiceReference2 {
    ...
    public interface IECommerce {
        ...
        Sito.ServiceReference2.ValueTupleOfbooleanstring buy(string address, int zip_code, string credit_card);
        
        [System.ServiceModel.OperationContractAttribute(ProtectionLevel=System.Net.Security.ProtectionLevel.EncryptAndSign, Action="http://tempuri.org/IECommerce/buy", ReplyAction="http://tempuri.org/IECommerce/buyResponse")]
        System.Threading.Tasks.Task<Sito.ServiceReference2.ValueTupleOfbooleanstring> buyAsync(string address, int zip_code, string credit_card);
    ...
    public partial class ECommerceClient : System.ServiceModel.ClientBase<Sito.ServiceReference2.IECommerce>, Sito.ServiceReference2.IECommerce {
        ...
        public Sito.ServiceReference2.ValueTupleOfbooleanstring buy(string address, int zip_code, string credit_card) {
            return base.Channel.buy(address, zip_code, credit_card);
        }
        
        public System.Threading.Tasks.Task<Sito.ServiceReference2.ValueTupleOfbooleanstring> buyAsync(string address, int zip_code, string credit_card) {
            return base.Channel.buyAsync(address, zip_code, credit_card);
        }
